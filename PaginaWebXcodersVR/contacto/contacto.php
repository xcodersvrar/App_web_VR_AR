        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="../inicio/inicio.php"><i class="fas fa-home me-1"></i> Inicio</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="../personal/personal.php"><i class="fas fa-person me-1"></i>Equipo</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="../catalogo/catalog.php"><i class="fas fa-building me-1"></i> Propiedades</a>
                    </li>
                </ul>
            </div>
        </div>
